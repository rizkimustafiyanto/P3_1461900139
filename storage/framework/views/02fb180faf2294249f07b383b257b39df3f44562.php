          ...
          <div class="card-body">
            <table id="example2" class="table table-bordered table-hover">
              <thead>
                ...
                <tbody>
                  <?php $no=1; ?>
                  <?php $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td><?php echo e($no++); ?></td>
                    <td><?php echo e($sa->nama); ?></td>
                    <td><?php echo e($sa->alamat); ?></td>
                    <td>
              ...
              <tr>
                  ...
                  <th>Nama</th>
                  <th>Alamat</th>
                  <th><a href="<?php echo e(route('siswa.create')); ?>" class="btn btn-sm btn-info">Tambah</a></th>
              </tr>
              </tfoot>
            </table>
          </div>
...
</html><?php /**PATH C:\xampp\htdocs\Praktikum\ketiga\resources\views/tampil/siswat.blade.php ENDPATH**/ ?>