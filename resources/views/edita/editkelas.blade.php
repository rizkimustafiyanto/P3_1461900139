        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="POST" action="{{route('kelas.update', $kelas->id)}}">
                @csrf
                @method('PUT')
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputnama1">Kode Siswa</label>
                    <input type="Text" name="id_siswa" class="form-control" value="{{$kelas->id_siswa}}" placeholder="Masukkan nama anda">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputmengajar1">Kode Guru</label>
                    <input type="Text" name="id_guru" class="form-control" value="{{$kelas->id_guru}}" placeholder="Bagian Matakuliah">
                  </div>
