        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              @endif
              <form id="quickForm" method="POST" action="{{route('guru.update',$guru->id)}}">
                @csrf
                @method('PUT')
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputnama1">Nama</label>
                    <input type="text" name="nama" class="form-control" value="{{$guru->nama}}" placeholder="Masukkan nama anda" value="">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputmengajar1">Mengajar</label>
                    <input type="Text" name="mengajar" class="form-control" value="{{$guru->mengajar}}" placeholder="Bagian Matakuliah">
                  </div>
