          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit Data siswa<small> Validation Input</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              @if ($errors->any())
              ...
              @endif
              <form id="quickForm" method="POST" action="{{route('siswa.update',$siswa->id)}}">
                @csrf
                @method('PUT')
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputnama1">Nama</label>
                    <input type="text" name="nama" class="form-control" value="{{$siswa->nama}}" placeholder="Masukkan nama anda" value="">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputmengajar1">Mengajar</label>
                    <input type="Text" name="mengajar" class="form-control" value="{{$siswa->mengajar}}" placeholder="Bagian Matakuliah">
                  </div>
