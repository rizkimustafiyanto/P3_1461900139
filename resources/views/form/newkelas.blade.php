        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="POST" action="{{route('kelas.store')}}">
                {{ csrf_field() }}
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputid_guru1">Kode Guru</label>
                    <input type="Text" name="id_guru" class="form-control" id="exampleInputid_guru1" placeholder="Bagian Matakuliah">
                  </div>
  ...
  $(function () {
    ...
    $('#quickForm').validate({
      ...
      messages: {
        ...
        id_guru: {
          required: "Tolong isi anda id_guru apa",
